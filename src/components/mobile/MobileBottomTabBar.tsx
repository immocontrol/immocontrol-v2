...
const TABS: TabItem[] = [
  ...
  { path: ROUTES.PERSONAL_DASHBOARD, label: "Dashboard", icon: Sparkles },
  {
    ...
    children: [
      ...
      { path: ROUTES.STEUER_COCKPIT, label: "Steuer", icon: Landmark },
      { path: ROUTES.REFINANZIERUNG, label: "Refinanzierung", icon: Landmark },
      { path: ROUTES.STRESS_TEST, label: "Stress-Test", icon: Landmark },
      { path: ROUTES.DIVERSIFIKATION, label: "Diversifikation", icon: Landmark },
      { path: ROUTES.MIETSPIEGEL, label: "Mietspiegel", icon: Landmark },
      { path: ROUTES.KPI_ZEITREISE, label: "KPIs Zeitverlauf", icon: Landmark },
  ...
  },
  {
    ...
    children: [
      ...
      { path: ROUTES.SYNDICATION, label: "Syndication", icon: FileText },
      { path: ROUTES.BENACHRICHTIGUNGEN, label: "Benachrichtigungen", icon: FileText },
  ...
  },
  {
    ...
    children: [
      ...
      { path: ROUTES.DEAL_BENCHMARK, label: "Deal-Benchmark", icon: Target },
