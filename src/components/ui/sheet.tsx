...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-border/80 bg-background/95 backdrop-blur-sm p-6 shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
    ...
    return (
      <SheetPortal>
        ...
        <SheetPrimitive.Content ref={setRef} className={cn(sheetVariants({ side }), className)} {...props}>
          {children}
          <VisuallyHidden>
            <SheetPrimitive.Title>Bereich</SheetPrimitive.Title>
            <SheetPrimitive.Description>
              Seitenbereich geöffnet. Schließen über die Schaltfläche oben rechts oder durch Klick außerhalb.
            </SheetPrimitive.Description>
          </VisuallyHidden>
