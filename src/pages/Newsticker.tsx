...
function detectRegion(title: string, description: string): "berlin" | "brandenburg" | "both" {
  ...
  const hasBrandenburg = /brandenburg|potsdam|cottbus|frankfurt.*oder|oranienburg|bernau|falkensee|eberswalde|ludwigsfelde|k\u00f6nigs.?wusterhausen|wildau|sch\u00f6nefeld|luckenwalde|strausberg|f\u00fcrstenwalde|neuruppin|wittenberge|rathenow|senftenberg|spremberg|guben|forst|eisenhuettenstadt|schwedt|prenzlau|templin|angerm\u00fcnde|bad\s?freienwalde|seelow|beeskow|l\u00fcbben|l\u00fcbbenau|herzberg|finsterwalde|elsterwerda|bad\s?belzig|brandenburg.*havel|werder|teltow|kleinmachnow|stahnsdorf|blankenfelde|mahlow|rangsdorf|zossen|baruth|j\u00fcterbog|dahme|nauen|ketzin|henningsdorf|velten|hohen\s?neuendorf|birkenwerder|glienicke|m\u00fchlenbecker|wandlitz|biesenthal|barnim|oberhavel|havelland|oder.?spree|spree.?nei\u00dfe|dahme.?spreewald|teltow.?fl\u00e4ming|ostprignitz|prignitz|uckermark|m\u00e4rkisch.?oderland/.test(text);
