      ...
      {totalTickets > 0 && (
        <div className="gradient-card rounded-xl border border-border p-5 animate-fade-in [animation-delay:200ms]">
          ...
          <div className="grid grid-cols-3 gap-2">
            {/* IMP-21: ARIA label for ticket button */}
            <button aria-label="Offene Tickets anzeigen" onClick={() => setActiveTab("tickets")} className="p-3 bg-gold/10 rounded-lg text-center hover:bg-gold/15 transition-colors">
